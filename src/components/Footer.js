    ...
    render(){
        return(
            ...
            <div className="b4foot">
              ...
              <h1 style={{fontSize: "14px", marginTop:"-10px", marginLeft: "5px" }}> <label style ={{background: "white", width:"500px", height:"100px"}} >FREE DOWNLOAD NOW</label><a href='https://apps.apple.com/app/id925015459' target="_blank"><img src="/pics/mac-os-filled.png" className="foothov" alt="cart" width="30" height="30" style={{marginLeft: "28px"}}/></a>
                <a href="https://play.google.com/store/apps/details?id=com.jumia.android&referrer=adjust_reftag%3DcdTxOjM" target="_blank"><img src="/pics/playstore-filled.png" className="foothov" alt="cart" width="30" height="30" style={{marginLeft: "35px"}} /></a></h1></div>
                </div>
