...
import { Home, Work, Language, RoomService, Stars } from '@material-ui/icons';

class FooterTwo extends Component {

    render (){
        return (
            <div className="coverboy" >
                <div className="divhide">
                   ...
                   <p className="lastp">MAKE MONEY WITH US</p>
                ...
                <li className="moreli"><a href="#" className="nomoreli">Jumia Prime</a></li>
                <li className="moreli"><a href="#" className="nomoreli">Terms and Conditions</a></li>
                <li className="moreli"><a href="#" className="nomoreli">Privacy Policy</a></li>
                <li className="moreli"><a href="#" className="nomoreli">Economy Postal Shipping</a></li>
                </div>
                ...
                <li className="moreli"><a href="#" className="nomoreli">Kenya</a></li>
                <li className="moreli"><a href="#" className="nomoreli">Morocco</a></li>
                <li className="moreli"><a href="#" className="nomoreli">Senegal</a></li>
                <li className="moreli"><a href="#" className="nomoreli">Tanzania</a></li>
                <li className="moreli"><a href="#" className="nomoreli">Tunisia</a></li>
                ...
                <div className="divhide">
                    ...
                    <p className="lastp">JUMIA GROUP</p>
                    <div className="jumicon">
                    <a href="#" className="nomoreli">JUMIA<Language style={{fontSize:"12px"}}/>TRAVEL</a> 
                    <a href="#" className="nomoreli">JUMIA<RoomService style={{fontSize:"12px"}}/>Food</a> 
                    <br/>
                    <a href="#" className="nomoreli">JUMIA<Work style={{fontSize:"12px"}}/>DEALS</a>
                    <a href="#" className="nomoreli">JUMIA<Home style={{fontSize:"12px"}}/>HOUSE</a>
                    <br/>
                    <a href="#" className="nomoreli">JUMIA<Stars style={{fontSize:"12px"}}/>ONE</a>
                    </div>
