...
class NavTwo extends Component{
    ...
    render(){
        return(
            ...
            <Dehaze style={{float: "left", marginRight: "10px", marginTop: "20px" }}/><h1 style={{ fontSize: "30px", float: "left" }}>JUMIA</h1><AddShoppingCart style={{float: "left", marginLeft: "1px", color: "orange", fontSize: '40px', marginTop: "20px"  }}/> 
